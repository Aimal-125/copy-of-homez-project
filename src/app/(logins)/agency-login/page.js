import styles from "./agencyStyles.module.css";
import agencyLogin from "../../../lib/agencyActions";
            ...
            <div className="col-lg-6" style={{ margin: "0 auto" }}>
              ...
              >
                <div className="text-center mb40">
                  ...
                  <form className={styles.userForm} action={agencyLogin}>
                    ...
                    <div>
                      <p className="dark-color text-center mb0 mt10">
                        ...
                        <a href="/agency-register" className="dark-color fw600">
                          SignUp
                        </a>
                      </p>
                    </div>
